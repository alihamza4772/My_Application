...
FluidSlider slider;
    MFabButtons(Context context, FloatingActionButton fab_button_1, FloatingActionButton fab_button_2, FloatingActionButton fab_button_3, FloatingActionButton fab_button_4, FluidSlider slider) {
